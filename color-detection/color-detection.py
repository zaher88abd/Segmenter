...
# root = Tk()
# root.filename =  filedialog.askopenfilename(initialdir = "/home/zaher",title = "Select file",filetypes = (("jpeg files","*.jpg"),("all files","*.*")))

path_=Path("/home/zaher/Pictures/box_circle/JPEG_Images")
